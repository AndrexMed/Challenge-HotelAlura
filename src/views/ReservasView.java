        ...
        txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
                    ...
                    LocalDate fechaInicio = txtFechaEntrada.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
                    LocalDate fechaFin = txtFechaSalida.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();

                    long dias = ChronoUnit.DAYS.between(fechaInicio, fechaFin);

                    long resultado = dias * valorPorDia;
                    ...
                    // Resto del código que deseas ejecutar si las fechas no están vacías
                } else {
                    // Código a ejecutar si las fechas están vacías
                }
